        ...
        <div className="mx-auto max-w-4xl px-6 text-center">
          <div className="rounded-[32px] h-100 bg-white/10 border border-white/12 p-8 md:p-14 shadow-2xl backdrop-blur-md">
            ...
            <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row sm:items-center">
              <a
                href="#manufacturing"
                className="inline-flex items-center justify-center rounded-full border border-emerald-400/60 bg-emerald-500 px-4 py-2 text-xs font-semibold text-white transition-all duration-200 hover:-translate-y-0.5 hover:bg-emerald-400 sm:text-sm"
              >
                Explore our plant
              </a>
              <Link
